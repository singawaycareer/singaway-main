...
export function Services() {
  return (
    <Section id="services">
      ...
      {/* Perfectly Balanced Responsive Bento Grid */}
      <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-6">
        {work.map((s, i) => {
          // Dynamic span configuration to perfectly fit 6 columns (Row 1: 4+2=6 | Row 2: 2+4=6)
