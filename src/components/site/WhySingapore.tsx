...
const stats = [
  ...
  { k: "S$3.5K+", v: "Avg. starting salary" },
];
  ...
  return (
    <Section id="why">
      ...
      <div className="mt-14 grid grid-cols-12 gap-3">
        ...
        >
          <img src={skyline} loading="lazy" alt="Singapore skyline" className="h-72 w-full object-cover sm:h-[420px]" />
        </motion.div>
        ...
        <div className="col-span-12 grid grid-cols-2 gap-3 md:col-span-5">
          ...
          <motion.img
            ...
            className="col-span-2 h-44 w-full rounded-3xl border border-border object-cover sm:h-[206px]"
          />
        </div>
      </div>
      ...
      <div className="mt-10 grid grid-cols-2 divide-x divide-border rounded-3xl border border-border bg-card sm:grid-cols-4">
        {stats.map((s) => (
          <div key={s.v} className="p-6 text-center">
            <p className="font-display text-3xl font-semibold tracking-tight sm:text-4xl">{s.k}</p>
