...
const organizationJsonLd = {
  ...
  name: 'Singaway',
  description:
    'Trusted Singapore career consultancy specializing in work permits, S Pass, Employment Pass, study visas and overseas placement support.',
  areaServed: { '@type': 'Country', name: 'Singapore' },
  serviceType:
    'Career Consultancy, Visa & Immigration Services, Overseas Placement',
}
